...
class TipsDetailsSceneRouter: NSObject, TipsDetailsSceneRoutingLogic, TipsDetailsSceneDataPassing
{
  ...
  //func navigateToSomewhere(source: TipsDetailsSceneViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: TipsDetailsSceneDataStore, destination: inout SomewhereDataStore)
  //{
